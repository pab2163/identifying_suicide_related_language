...
```{r}
maps_ids = read.csv('maps_validation_ids.txt', header = FALSE)
id_to_recode = as.character(maps_ids$V1[11])

load(paste0('../../../data/Preprocessed/MAPS_', id_to_recode, '_Preprocessed_Sanitized_Untranslated_03_21_25.RData'))


df_id_to_recode = finalmessages

# training dataset for lexicon development (first 12000 entries, not included in validation set)
train_12000 = df_id_to_recode %>% head(12000) 
write.csv(train_12000, paste0(
  '../../../data/Preprocessed/MAPS_', id_to_recode, '_Preprocessed_Sanitized_Untranslated_03_21_25_first_12000.csv'), row.names = FALSE)

load('../../../data/Preprocessed/MAPS_Language_Preprocessed_Sanitized_Untranslated_03_11_25.RData')


# Delegate
to_code = rbind(df_id_to_recode, finalmessages)
...
write.csv(coded, paste0('../../../data/Preprocessed/MAPS_', id_to_recode, '_Preprocessed_Sanitized_Untranslated_03_21_25_first_12000_coded.csv'), row.names = FALSE)
...
subdirs = as.numeric(maps_ids$V1)
